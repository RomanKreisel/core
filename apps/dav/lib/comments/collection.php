...
class Collection implements ICollection {
	...
	/**
	 * initializes the connection. At this point of time, we need the logged in
	...
	protected function initCollections() {
		...
		$this->entityTypeCollections['files'] = new EntityTypeCollection('files', $this->commentsManager, $userFolder);
	}
